    ...
    return <>
        <div className='landing'>
            ...
            <Card className={sections[2]}>
                ...
                <Alert color='success' startDecorator={<MdInfo />} sx={{ width: 'fit-content', margin: '0 auto' }}><Typography sx={{ color: 'inherit', fontSize: 'inherit' }}>You can find more in the <Link sx={{ fontSize: 'inherit' }} color='success' onClick={questionBankLinkOnClick}>Radiology Interview Question Bank</Link></Typography></Alert>
                <ExampleQuestions />
            </Card>
